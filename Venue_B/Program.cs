...
namespace Venue_B
{
    public class Program
    {
        ...
        private static readonly TimeSpan UpdateInterval = TimeSpan.FromMilliseconds(350);
        private static readonly TimeSpan HeartbeatInterval = TimeSpan.FromSeconds(5);
        private static readonly string VenueName = "Venue_B";
        ...
        private static async Task BroadcastLoopAsync()
        {
            while (true)
            {
                ...
                foreach (var prod in Products)
                {
                    ...
                    var delta = ((decimal)_rng.NextDouble() - 0.5m) * 0.03m;
