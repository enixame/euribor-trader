...
namespace Venue_A
{
    public class Program
    {
        ...
        private static readonly string VenueName = "Venue_A";
        ...
        {
            // Determine current bid/ask for product
        ...
        private static async Task BroadcastLoopAsync()
        {
            while (true)
            {
                ...
                foreach (var prod in Products)
                {
                    ...
                    var bytes = JsonSerializer.SerializeToUtf8Bytes(update, new JsonSerializerOptions { PropertyNamingPolicy = JsonNamingPolicy.CamelCase });
